    ...
    <div class="container">
        ...
        <div class="card card-container">
            ...
            <form name="form-inserirCod" class="form-inserirCod" onsubmit="return validarCod()" action="PHP\verificar_cod_atv.php" method="POST">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-inserirCod" name="enviar-cod-security" type="submit">Confirmar</button>



                <p>Foi enviado um c&oacute;digo de segurança para o seu email</p>
            ...
            <form name="resendEmail" action="PHP\verificar_cod_atv.php" method="POST">
                ...
                <button class="btn btn-lg btn-block" type="enviar" name="resendSecurity" id="resendBTN">
                    <p id="resend">N&atilde;o recebi o c&oacute;digo</p>
                </button>
