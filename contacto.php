...
<head>
	...
	<link href="CSS/contactostyle.css" rel="stylesheet">
...
<div class="container">
        <div class="card card-container">
			...
			<div class="allInputs">
			<form name="form-contacto" class="form-contacto" onsubmit="return validarContacto()" action="PHP\contacto.php" method="POST">

			<?php if(isset($_GET['erro_contacto'])){ ?>
          		<div class="mensagem_contacto"><?php echo $_GET['erro_contacto']; ?></div>
			<?php } ?>
			...
			<span id="mensagem_erro"></span>
				...
				<textarea name="inputMensagem" id="inputMensagem" class="md-textarea form-control" rows="5" placeholder="Mensagem"></textarea>
			</div>


                <button name="enviar-form" class="btn btn-lg btn-primary btn-block btn-contacto" type="submit">Enviar</button>
            </form><!-- /form -->
        </div><!-- /card-container -->
    </div><!-- /container -->
