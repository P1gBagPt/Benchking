...
<div class="container">
    <br><br>
        <h1 class="title text-center">Noticias no mundo do software</h1>
    <hr><hr>
...
if(file_exists('news.json')){
  ...
  $news_keyword = 'games'; //we will be fetching only sports related news
  $news_language = 'pt';

  $api_url = 'http://newsapi.org/v2/everything?q='.$news_keyword.'&language='.$news_language.'&sortBy=popularity&apiKey=a136f6200ab14468b36d24ace9625bbd';
...
<div class="row single-news">
  ...
  <div class="col">
    ...
    <a href="<?php echo $news->url;?>" class="btn btn-sm btn-primary" style="float:right;" target="_blank">Ler mais >></a>
  </div>
