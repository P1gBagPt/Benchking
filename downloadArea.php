...
if(isset($_POST['button-down'])){
        require_once ('PHP/conexao.php');
        $downloads = "INSERT INTO dc463jjk_benchking.downloads (download_date) VALUES (CURRENT_TIMESTAMP)";
...
<head>
	...
	<link href="CSS/downloadstyle.css" rel="stylesheet">
...
<div class="container">
        <div class="card card-container">
				...
				<a href="PHP/download.php">Download</a>

                <h1 class="updatedH1">Detalhes</h1>

                <ul class="details">
                    <a href="https://www.maxon.net/en/cinebench/"><li>Cinebench</li></a>
                    <a href="https://geeks3d.com/furmark/"><li>FurMark</li></a>
                    <a href="https://benchmark.unigine.com/heaven/"><li>Unigine Heaven</li></a>
                </ul>

                <h6 class="updatedH6">Atualizado a 22/06/2021</h6>
