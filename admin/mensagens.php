                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Mensagens do Form Contacto</h5>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <?php require_once ('../PHP/conexao.php');
                                                              $sql = "SELECT id, nome, email, mensagem FROM dc463jjk_benchking.inbox";
                                                              $result = $conn->query($sql);
                                                                ...
                                                                while($row = $result->fetch_assoc()) {
                                                                    echo "<tr>";
                                                                        ...
                                                                        echo "<td><a class='btn btn-danger' href='assets/php/crud/deleteMens.php?id=" . $row['id'] . "'>Eliminar</a></td>";
                                                                    echo "</td>";
